Shop()
{
	...
	web_custom_request("GetAccountByIdRequest_2",
		...
		"Body=<?xml version=\"1.0\" encoding=\"UTF-8\"?><soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\"><soap:Body><GetAccountByIdRequest xmlns=\"com.advantage.online.store.accountservice\"><accountId>{userId}</accountId><base64Token>Basic dXNlcjU6UGFzc3dvcmQx</base64Token></GetAccountByIdRequest></soap:Body></soap:Envelope>",
		LAST);
	...
	web_custom_request("GetAccountByIdNewRequest_2",
		...
		"Mode=HTML",
		"EncType=text/xml; charset=UTF-8",
		"Body=<?xml version=\"1.0\" encoding=\"UTF-8\"?><soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\"><soap:Body><GetAccountByIdNewRequest xmlns=\"com.advantage.online.store.accountservice\"><accountId>{userId}</accountId><base64Token>Basic dXNlcjU6UGFzc3dvcmQx</base64Token></GetAccountByIdNewRequest></soap:Body></soap:Envelope>",
		LAST);
	...
	web_custom_request("shippingcost_2",
		...
		"Body={\"seaddress\":{\"addressLine1\":\"somewhere\",\"addressLine2\":\"\",\"city\":\"Paris\",\"country\":\"au\",\"postalCode\":75000,\"state\":\"state\"},\"secustomerName\":\"User One\",\"secustomerPhone\":123456,\"senumberOfProducts\":1,\"setransactionType\":\"SHIPPING_COST\",\"sessionId\":\"{sessionId}\"}",
		LAST);
	...
	web_custom_request("959169513_5",
		"URL=http://{host_nimbusserver_aos_com_8002}/order/api/v1/orders/users/{userId}",
		"Method=OPTIONS",
		"Resource=0",
		"Referer=http://{host_nimbusserver_aos_com_8000}/",
		"Snapshot=t38.inf",
	...
	web_custom_request("UpdateSafePayMethodRequest_2",
		...
		"Mode=HTML",
		"EncType=text/xml; charset=UTF-8",
		"Body=<?xml version=\"1.0\" encoding=\"UTF-8\"?><soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\"><soap:Body><UpdateSafePayMethodRequest xmlns=\"com.advantage.online.store.accountservice\"><userId>{userId}</userId><safePayUsername>admin</safePayUsername><safePayPassword>399a69dfc502</safePayPassword><referenceId>1234567890</referenceId><base64Token>Basic dXNlcjU6UGFzc3dvcmQx</base64Token></UpdateSafePayMethodRequest></soap:Body></soap:Envelope>",
		LAST);
